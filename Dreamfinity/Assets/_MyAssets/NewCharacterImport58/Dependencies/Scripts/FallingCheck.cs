...
public class FallingCheck : StateMachineBehaviour {
    ...
    private void Awake()
    {
        charRef = GameObject.FindWithTag("Player");
        rigbodRef = charRef.GetComponent<Rigidbody>();
        charContRef = charRef.GetComponent<CharacterControler>();
    }
